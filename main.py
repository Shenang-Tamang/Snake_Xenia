...
class Game:
    ...
    def play(self):
        ...
        if self.isCollision(self.snake.x[0], self.snake.y[0], self.apple.x, self.apple.y):
            ...
            self.play_sound("resources/eat.mp3")
        ...
        for i in range(3, self.snake.length):
            if self.isCollision(self.snake.x[0], self.snake.y[0], self.snake.x[i], self.snake.y[i]):
                self.play_sound("resources/gameover.mp3")
    ...
    def show_game_over(self):
        ...
        line2 = font.render("To play agian press Enter. To exit press Escape", True, (255, 255, 255))
